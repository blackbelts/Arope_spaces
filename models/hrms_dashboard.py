...
class Brokers(models.Model):
    ...
    def get_person_info(self,id):
        ...
        return {'name':obj.name ,'fra': obj.fra_no if obj.fra_no else '', 'exp_date': obj.expire_date if obj.expire_date else '', 'mobile': obj.mobile if obj.mobile else '', 'mail': obj.login if user.login else''}
